...
PowerController::PowerController(double voltageKp, double voltageKi,
                                 double voltageKd, double currentKp,
                                 double currentKi, double currentKd)
...
bool PowerController::isCurrentMode() const { return _currentMode; }

bool PowerController::isRestMode() const { return _restMode; }

int PowerController::getVoltageDuty() const { return _voltageDuty; }

int PowerController::getCurrentDuty() const { return _currentDuty; }
